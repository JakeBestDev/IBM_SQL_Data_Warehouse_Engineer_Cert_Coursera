-- ACID PROCEDURE EXAMPLE 2 --
-- Uses the BankAccounts and ShoeShop tables. RUN SQL CREATE STATEMENTS FIRST TO CREATE THE DATA!! --


-- 1) Exercise 2 - ACID PROCEDURE 

-- A) Create a stored procedure TRANSACTION_JAMES to execute a transaction based on the following scenario: 
